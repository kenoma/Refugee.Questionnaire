...
using CvLab.TelegramBot.Repo;
using Refugee.Questionnaire.DTO;
using Telegram.Bot;
using Telegram.Bot.Types;
using Telegram.Bot.Types.Enums;

namespace CvLab.TelegramBot.Impl.Entry
{
    internal class EntryConfigureChat
    {
        private readonly TelegramBotClient _botClient;
        private readonly ServiceStates _states;

        public EntryConfigureChat(TelegramBotClient botClient, ServiceStates states)
        {
